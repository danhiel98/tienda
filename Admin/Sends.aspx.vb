...
Partial Class Admin_Requests
    ...
    Protected Sub ObtenerDatos()
        ...
        For i = 0 To envios.Rows.Count - 1
            ...
            d = d & "<tr>"
            d = d & "<td>"
            d = d & "<a class='btn btn-default btn-sm' href='SendDetail.aspx?idReq=" & envios.Rows(i).Item("id") & "'><span class='fa fa-eye'></a>"
            d = d & "</td>"
            d = d & "<td>" & i + 1 & "</td>"
            d = d & "<td>"
            ...
            d = d & "<a class='btn btn-success btn-xs btn-edit' href='SendRequest?idSend=" & envios.Rows(i).Item("id") & "'>Entregado</a>"
            d = d & "</td>"
            d = d & "</tr>"
        Next
        lblDatos.Text = d
